...
//    }
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.csrf().disable()
                ...
                .antMatchers("/api/v1/users/recover/initiate").permitAll()
                .antMatchers("/api/v1/users/recover/identify").permitAll()
                .antMatchers("/api/v1/users/recover/password").permitAll()
